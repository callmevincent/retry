...
public class RetryAspect {
    ...
    public Object doAround(ProceedingJoinPoint point, RetryStrategy retryStrategy) {
        ...
        try {
            ...
            log.error("请求出错 {}", th.getMessage(), th);
            RetryContext retryContext = new DefaultRetryContext(new RetryConfiguration(point, retryStrategy));
            publisher.publishEvent(retryContext);
            return defaultResult(retryContext.getContextId());
        }
        return result;
    }
